    ...
    protected void execute(CommandEvent event)
    {
        ...
        embed2.setDescription(
            """
                ...
                <@&747067845392728134> - People that have donated to the fundraiser for **<@106553164731305984>'s new PC.**""");
        ...
        event.reply("""
            If you want to invite people to this server, feel free to do so! Here's the link:
            <https://edmlyrics.community>
            
            We also have another server where we host one hour lyric challenges here:
